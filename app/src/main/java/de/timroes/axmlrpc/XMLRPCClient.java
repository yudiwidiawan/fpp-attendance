...
public class XMLRPCClient {
	 ...
	 * used, calls to {@link #installCustomTrustManager(TrustManager)}
	 ...
	 * be thrown for calls made by {@link #call(String, Object[])}.
	 * For calls made by {@link #callAsync(de.timroes.axmlrpc.XMLRPCCallback, String, Object[])}
	 ...
	 *
	 * @see #installCustomTrustManagers(TrustManager[])
	 */
	 ...
	 *
	 * @see #installCustomTrustManager(TrustManager)
	 */
     ...
     *
     * @see #installCustomKeyManagers(KeyManager[])
     */
     ...
     *
     * @see #installCustomKeyManager(KeyManager)
     */
