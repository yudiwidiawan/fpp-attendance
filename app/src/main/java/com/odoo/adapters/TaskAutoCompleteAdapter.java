...
public class TaskAutoCompleteAdapter extends BaseAdapter implements Filterable {

    private Context context;
    private ArrayList<TaskModel> originalList;
    private ArrayList<TaskModel> suggestions = new ArrayList<>();
    private Filter filter = new CustomFilter();
    private int selectedId = 0;

    public TaskAutoCompleteAdapter(Context context, ArrayList<TaskModel> originalList) {
