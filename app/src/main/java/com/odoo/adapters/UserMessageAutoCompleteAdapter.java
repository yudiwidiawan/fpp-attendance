...
public class UserMessageAutoCompleteAdapter extends BaseAdapter implements Filterable {

    private Context context;
    private ArrayList<OUser> originalList;
    private ArrayList<OUser> suggestions = new ArrayList<>();
    private Filter filter = new CustomFilter();

    public UserMessageAutoCompleteAdapter(Context context, ArrayList<OUser> originalList) {
    ...
    public long getItemId(int position) {
        return suggestions.get(position).getUserId();
    }
